...
- screenshot 截图 (托盘菜单 / 热键设置 / 权限引导)
"""

from i18n_strings import cloud, main, misc, plugins, screenshot, settings


def load_all() -> dict:
    """合并所有领域文件的 STRINGS,返回 dict[lang][key] -> value。"""
    merged: dict = {}
    for module in (main, settings, cloud, plugins, misc, screenshot):
